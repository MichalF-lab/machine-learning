...
# YOLO BCCD classes are alphabetical (from BccdSetup.py: ['Platelets','RBC','WBC'])
# FRCNN needs 1-based class ids (0 = background)
_YOLO_TO_FRCNN = {0: 3, 1: 1, 2: 2}   # Platelets→3, RBC→1, WBC→2


class BCCDYoloDataset(GenericDetectionDataset):
