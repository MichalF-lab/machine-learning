...
def generate_anchors(feature_map, image_size, anchor_scales,anchor_ratios):
    ...
    num_anchors = len(anchor_scales) * len(anchor_ratios) # tworzymy np. 9 anchor boxów dla każdego anchora
    ...
    anchors = anchors.reshape(1, -1, 4).expand(B, -1, -1)
    return anchors
