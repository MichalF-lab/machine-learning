...
def run_vit_best_20ep():
    ...
    print(f"\n=== ViT_Best (patch_size=2) 20 epok — Imagenette ===")
    ...
    print(f"vs ViT_Best  10ep ImageNet: {result['vs_10ep_imagenet']}%  → "
          f"{'+'if result['best_test_acc'] > result['vs_10ep_imagenet'] else ''}"
          f"{result['best_test_acc'] - result['vs_10ep_imagenet']:.2f}%")
    print(f"vs ViT_Medium 20ep ImageNet: {result['vs_medium_20ep_imagenet']}%  → "
